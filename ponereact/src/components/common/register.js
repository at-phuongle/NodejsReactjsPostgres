...
function Register(props) {
  ...
  function handleChangeImage(event) {
    ...
    setAvatarUp(URL.createObjectURL(event.target.files[0]));
  }
  ...
  function handleSubmit(e) {
    ...
    if (!name) {
      ...
      if (password !== rePassword) {
        ...
        const newAccount = { avatar: imageAvatar, name: name, address: address, phoneNumber: phoneNumber, username: username, password: password, rePassword: rePassword };
        ...
        <div className="section-wrap">
          ...
          <form className="form form-register">
            <div className="add-img-product">
              <img className="col-6 img-product-form" src={avatarUp} alt="Please chose image product!" />
